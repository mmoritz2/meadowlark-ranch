...
export function install(G){
 ...
 if(!/Second wind/.test(G.tables.MASTERY_UNLOCKS[7]||''))G.tables.MASTERY_UNLOCKS[7]=(G.tables.MASTERY_UNLOCKS[7]?G.tables.MASTERY_UNLOCKS[7]+' · ':'')+'Second wind: recover from blown 30% faster';   // mastery-style also labels slot 7 (Breed perk IV): keep both
 function onBlown(){
